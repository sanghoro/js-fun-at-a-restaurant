...
var vegetables = ['spinach', 'broccoli', 'onion', 'carrot', 'romaine'];
...
var fruits = ['apple', 'banana', 'grape', 'strawberry', 'watermelon', 'orange', 'kiwi'];
...
// sellsLottery: true/false,
// size: 1000
// address: 'whichever street'
